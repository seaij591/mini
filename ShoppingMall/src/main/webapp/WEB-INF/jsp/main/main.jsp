...
<title>키큰남자 쇼핑몰</title>
<!-- Hero Section Begin -->
<section class="hero">
	<div class="hero__slider owl-carousel">
		<div class="hero__items set-bg" data-setbg="img/hero/main3.png">
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-7 col-md-8">
						<div class="hero__text">
							<h6>Spring Season</h6>
							<h2>Winter - Spring Collections 2030</h2>
		...
		<div class="hero__items set-bg" data-setbg="img/hero/main1.jpg">
			
		</div>
		<div class="hero__items set-bg" data-setbg="img/hero/main2.jpg">
